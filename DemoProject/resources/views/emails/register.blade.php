...
<body>
	...
	<p>To log in when visiting our site just click Login or My Account at the top of every page, and then enter your email address and password.</p>
	<div class="container" style="display: block; background-color: #DCDCDC;">
	<table>
		<tr><td>Use the following values when prompted to log in:</td></tr>
